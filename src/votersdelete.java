...
public class votersdelete extends JFrame implements ActionListener{
	JLabel p1,a;
	JComboBox t1;
	JButton btn,btn1;
	Connection con;
	...
	public static void main(String[] args) {
		...
		votersdelete obj=new votersdelete();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn)
		{
			try 
			{
				...
				String sql="delete from voters where voterid=?";
