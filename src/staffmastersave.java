...
import javax.swing.*;
import java.sql.*;
public class staffmastersave extends JFrame implements ActionListener {
	JLabel a,b,b1,b2,b3,b4;
	JTextField d,d1,d2,d3,d4;
	JButton btn,btn1,btn2;
	public staffmastersave() {
		setTitle("StaffMaster Insert");
		setSize(700,700);
		setLayout(null);
		a=new JLabel("Staff Master");
	...
	public static void main(String[] args) {
		...
		staffmastersave obj=new staffmastersave();
	}
	@Override
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn)
		{
			...
			try
			{
				...
				String sql="insert into staffmaster values(?,?,?,?,?)";
