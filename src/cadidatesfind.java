...
public class cadidatesfind extends JFrame implements ActionListener{
	JLabel a,b,b1,b2,b3,b4,b5;
	JTextField d1,d2,d3,d4,d5;
	JButton btn1,btn2;
	Connection con;
	PreparedStatement st;
	ResultSet rs;
	JComboBox d;
	public cadidatesfind() {
		setTitle("Cadidates Master");
		setSize(800,800);
		setLayout(null);
		getContentPane().setBackground(Color.RED);
		a=new JLabel("Cadidates Find");
		a.setFont(new Font("Times New Roman",Font.BOLD,30));
		a.setForeground(Color.BLUE);
		a.setBounds(250,20,200,30);
		add(a);
		b=new JLabel("Cnadidate Id");
	...
	public static void main(String[] args) {
		...
		cadidatesfind obj=new cadidatesfind();
	}
	@Override
