...
public class partymasterdelete extends JFrame implements ActionListener{
	JLabel p1,a;
	JComboBox t1;
	JButton btn,btn1;
	Connection con;
	...
	ResultSet rs;
	public partymasterdelete()
	{
		setTitle("Party Master Deleted");
		setSize(800,800);
		setLayout(null);
		getContentPane().setBackground(Color.GREEN);
		
		p1=new JLabel("Party Master Delete");
	...
	public static void main(String[] args) {
		...
		partymasterdelete obj=new partymasterdelete();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn)
		{
			try 
			{
				...
				String sql="delete from partymaster where partyid=?";
