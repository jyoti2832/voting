...
public class electionscheduledelete extends JFrame implements ActionListener{
	JLabel p1,a;
	JComboBox t1;
	JButton btn,btn1;
	Connection con;
	...
	ResultSet rs;
	public electionscheduledelete()
	{
		setTitle("Election Schedule Deleted");
		setSize(800,800);
		setLayout(null);
		getContentPane().setBackground(Color.GREEN);
		
		p1=new JLabel("Election Schedule Delete");
	...
	public static void main(String[] args) {
		...
		electionscheduledelete obj=new electionscheduledelete();
