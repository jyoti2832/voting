...
public class cadidatesdelete extends JFrame implements ActionListener{
	JLabel p1,a;
	JComboBox t1;
	JButton btn,btn1;
	Connection con;
	...
	ResultSet rs;
	public cadidatesdelete()
	{
		setTitle("Cadidates Deleted");
		setSize(800,800);
		setLayout(null);
		getContentPane().setBackground(Color.PINK);
		
		p1=new JLabel("Cnadiadte Id");
	...
	public static void main(String[] args) {
		...
		cadidatesdelete obj=new cadidatesdelete();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn)
		{
			try 
			{
				...
				String sql="delete from cadidates where cnadiadteid=?";
