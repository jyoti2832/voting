...
public class partymasterfind extends JFrame implements ActionListener{
	JLabel a,b,b1,b2;
	JTextField d1,d2;
	JButton btn1,btn2;
	Connection con;
	...
	ResultSet rs;
	JComboBox d;
	public partymasterfind() {
		setTitle("Party Master");
		setSize(700,700);
		setLayout(null);
		getContentPane().setBackground(Color.RED);
		a=new JLabel("Party Master Find");
	...
	public static void main(String[] args) {
		...
		partymasterfind obj=new partymasterfind();
	}
	@Override
