...
public class votingdatadelete extends JFrame implements ActionListener{
	JLabel p1,a;
	JComboBox t1;
	JButton btn,btn1;
	Connection con;
	...
	ResultSet rs;
	public votingdatadelete()
	{
		setTitle("Votingdata Deleted");
		setSize(800,800);
		setLayout(null);
		getContentPane().setBackground(Color.GREEN);
		
		p1=new JLabel("Votingdata Delete");
	...
	public static void main(String[] args) {
		...
		votingdatadelete obj=new votingdatadelete();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn)
		{
			try 
			{
				...
				String sql="delete from votingdata where voterid=?";
