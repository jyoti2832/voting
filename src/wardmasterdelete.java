...
public class wardmasterdelete extends JFrame implements ActionListener{
	JLabel p1,a;
	JComboBox t1;
	JButton btn,btn1;
	Connection con;
	...
	ResultSet rs;
	public wardmasterdelete()
	{
		setTitle("Ward Master Deleted");
		setSize(800,800);
		setLayout(null);
		getContentPane().setBackground(Color.GREEN);
		
		p1=new JLabel("Ward Master Delete");
	...
	public static void main(String[] args) {
		...
		wardmasterdelete obj=new wardmasterdelete();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn)
		{
			try 
			{
				...
				String sql="delete from wardmaster where wardno=?";
