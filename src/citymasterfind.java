...
public class citymasterfind extends JFrame implements ActionListener{
	...
	ResultSet rs;
	JComboBox d;
	public citymasterfind() {
		setTitle("City Master");
		setSize(700,700);
		setLayout(null);
		getContentPane().setBackground(Color.RED);
		a=new JLabel("City Master Find");
		...
		d4.setFont(new Font("Arial",Font.BOLD,20));
	...
	public static void main(String[] args) {
		...
		citymasterfind obj=new citymasterfind();
	}
	@Override
		...
		if(ae.getSource()==btn1)
		{
			try
			{
				...
				if(rs.next())
				{
					...
					d2.setText(String.valueOf(rs.getString(2)));
